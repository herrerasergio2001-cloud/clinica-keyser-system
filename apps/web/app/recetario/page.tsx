...
export default function DigitalPrescriptionPage() {
  ...
  async function printPrescription(item: DigitalPrescription) {
    try {
      ...
      popup.document.write(prescriptionDocument(item, settings, logo, signature));
